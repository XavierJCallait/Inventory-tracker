...
public class HibernateUtil {
  ...
  public static synchronized void initializeSessionFactory(Properties databaseProperties) {
    ...
    try {
      ...
      configuration.addAnnotatedClass(app.model.category.Clothes.class);
      configuration.addAnnotatedClass(app.model.category.Food.class);
      configuration.addAnnotatedClass(app.model.category.Electronics.class);
