...
public class HibernateUtil {
    ...
    /**
     * Initializes the Hibernate SessionFactory using provided properties.
    ...
    public static synchronized void initializeSessionFactory(Properties databaseProperties) {
        ...
        try {
            Configuration configuration = new Configuration().configure(); // load hibernate.cfg.xml if needed
            configuration.setProperty("hibernate.connection.url", databaseProperties.getProperty("DB_URL"));
            configuration.setProperty("hibernate.connection.username", databaseProperties.getProperty("DB_USER"));
            configuration.setProperty("hibernate.connection.password", databaseProperties.getProperty("DB_PASSWORD"));
    ...
    public static SessionFactory getSessionFactory() {
        if (sessionFactory == null) {
            throw new IllegalStateException("SessionFactory is not initialized. Call initializeSessionFactory() first.");
        }
